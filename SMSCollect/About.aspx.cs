...
public partial class About : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        tresc.Text = "Zajec nie bedzie";
        TableCell data = new TableCell();
        data.Text = "22.01.14";
        TableCell godzina = new TableCell();
        godzina.Text = "10:15";
        TableCell dostarczone = new TableCell();
        dostarczone.Text = "30/30";
        row1.Cells.Add(odbiorca);
        row1.Cells.Add(tresc);
        row1.Cells.Add(data);
        row1.Cells.Add(godzina);
        row1.Cells.Add(dostarczone);
        myTable.Rows.Add(row1);

        TableRow row2 = new TableRow();
        TableCell odbiorca1 = new TableCell();
        odbiorca1.Text = "DSTD 1CB";
        TableCell tresc1 = new TableCell();
        tresc1.Text = "Spoznie sie 80 minut. Czekajcie";
